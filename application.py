...
def hangman_single():
    ...
    if request.method == "GET":
        ...
        file = open("correct_words.txt","r+")
        file. truncate(0)
        file. close()
        file = open("incorrect_words.txt","r+")
        file. truncate(0)
        file. close()
        print("files have been delted")
        #declaring variables 
        ...
        letters_dict={}
        return render_template("hangman_single.html",user_letters_list=user_letters_list,letters_dict=letters_dict)
        ...
        for i in ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z']:
            letters_dict[i]="table"
        

        file = open("incorrect_words.txt", "r")
        incorrect_words_list = list()
        for line in file:
            incorrect_words_list.append(line.rstrip('\n'))
        
        for i in incorrect_words_list:
            letters_dict[i]="wrong"
        ...
        if user_letter_guess==word[5]:
            ...
            file = open("incorrect_words.txt", "a+")
            file.write(user_letter_guess +"\n")
            letters_dict[user_letter_guess]="wrong"
            lives-=1
            if lives==0:
                db.execute("DELETE FROM hangman WHERE id =:id",id=session["user_id"])
        ...
        return render_template("hangman_single.html",user_letters_list=user_letters_list,hearts=hearts,letters_dict=letters_dict)
